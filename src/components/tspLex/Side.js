...
const Side = () => {
  ...
  return (
    <Paper className={`${classes.paper} ${classes.side}`}>
      ...
      <Typography>
        The travelling purchaser problem and the vehicle routing problem are both generalizations of TSP. The problem
        was first formulated in 1930 and is one of the most intensively studied problems in optimization. It is used as
        a benchmark for many optimization methods. Even though the problem is computationally difficult, many heuristics
        and exact algorithms are known, so at some instances with tens of thousands of cities can be solved completely
